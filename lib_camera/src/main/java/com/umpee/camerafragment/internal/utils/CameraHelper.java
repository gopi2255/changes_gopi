package com.umpee.camerafragment.internal.utils;
    ...
    public static CamcorderProfile getCamcorderProfile(@Configuration.MediaQuality int mediaQuality, int cameraId) {
        if (Build.VERSION.SDK_INT > 10) {
            if (mediaQuality == Configuration.MEDIA_QUALITY_HIGHEST) {
                ...
                if (CamcorderProfile.hasProfile(cameraId, 1009)) {
                    return CamcorderProfile.get(cameraId, 1009);
                } else if (CamcorderProfile.hasProfile(cameraId, 1010)) {
                    return CamcorderProfile.get(cameraId, 1010);
                } else if (CamcorderProfile.hasProfile(cameraId, CamcorderProfile.QUALITY_480P)) {
                    return CamcorderProfile.get(cameraId, CamcorderProfile.QUALITY_480P);
                }  else {
                    return CamcorderProfile.get(cameraId, CamcorderProfile.QUALITY_HIGH);
                ...
                if (CamcorderProfile.hasProfile(cameraId,  1011)) {
                    return CamcorderProfile.get(cameraId,  1011);
