package com.umpee.camerafragment.internal.ui;
...
import com.umpee.camerafragment.R;
...
import com.umpee.camerafragment.configuration.ConfigurationProviderImpl;
import com.umpee.camerafragment.internal.controller.CameraController;
import com.umpee.camerafragment.internal.controller.impl.Camera1Controller;
import com.umpee.camerafragment.internal.controller.impl.Camera2Controller;
import com.umpee.camerafragment.internal.controller.view.CameraView;
import com.umpee.camerafragment.internal.enums.Camera;
import com.umpee.camerafragment.internal.enums.Flash;
import com.umpee.camerafragment.internal.enums.MediaAction;
import com.umpee.camerafragment.internal.enums.Record;
import com.umpee.camerafragment.internal.timer.CountdownTask;
import com.umpee.camerafragment.internal.timer.TimerTask;
import com.umpee.camerafragment.internal.timer.TimerTaskBase;
...
import com.umpee.camerafragment.internal.ui.view.AspectFrameLayout;
import com.umpee.camerafragment.internal.utils.CameraHelper;
import com.umpee.camerafragment.internal.utils.Size;
import com.umpee.camerafragment.internal.utils.Utils;
...
public abstract class BaseAnncaFragment<CameraId> extends Fragment implements CameraFragmentApi {
    ...
    protected void onStartVideoRecord(final File mediaFile) {
        ...
        if (maxVideoFileSize > 0) {
            ...
            if (cameraFragmentVideoRecordTextListener != null) {
                cameraFragmentVideoRecordTextListener.setRecordSizeText(maxVideoFileSize, 0, "1MB" + " / " + maxVideoFileSize / (1024 * 1024) + "MB");
            ...
            try {
                fileObserver = new FileObserver(this.mediaFilePath) {
                    ...
                    public void onEvent(int event, String path) {
                        ...
                        final long fileSize = size / (1024 * 1024);
                        if ((fileSize - lastUpdateSize) >= 1) {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                ...
                                public void run() {
                                    if (cameraFragmentVideoRecordTextListener != null) {
                                        cameraFragmentVideoRecordTextListener.setRecordSizeText(maxVideoFileSize, size, fileSize + "MB" + " / " + maxVideoFileSize / (1024 * 1024) + "MB");
