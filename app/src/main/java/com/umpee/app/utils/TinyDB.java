...
public class TinyDB {
    ...
    /**
     * Decodes the Bitmap from 'url' and returns it
     *
    ...
    /**
     * Returns the String url of the last saved image
     *
     * @return string url of the last saved image
     */
     ...
     *
     * @param theFolder    the folder url dir you want to save it to e.g "DropBox/WorkImages"
     * @param theImageName the name you want to assign to the image file e.g "MeAtLunch.png"
     * @param theBitmap    the image you want to save as a Bitmap
     * @return returns the full url(file system address) of the saved image
     */
     ...
     *
     * @param fullPath  full url of the image file e.g. "Images/MeAtLunch.png"
     * @param theBitmap the image you want to save as a Bitmap
    ...
    /**
     * Creates the url for the image with name 'imageName' in DEFAULT_APP.. directory
     *
     * @param imageName name of the image
     * @return the full url of the image. If it failed to create directory, return empty string
     */
    ...
    /**
     * Saves the Bitmap as a PNG file at url 'fullPath'
     *
     * @param fullPath url of the image file
    ...
    /**
     * Delete image file at 'url'
     *
     * @param path url of image file
