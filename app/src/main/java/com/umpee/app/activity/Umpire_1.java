...
public class Umpire_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_umpire_1);

        btn_slomo12 = (Button)findViewById(R.id.u1_slowmo_12);
        btn_slomo14 = (Button)findViewById(R.id.u1_slowmo_14);
        btn_slomo34 = (Button)findViewById(R.id.u1_slowmo_34);
        btn_normal = (Button)findViewById(R.id.u1_slowmo_normal);
